...
import { WeekLoadGrid } from "@/components/planning/WeekLoadGrid";
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-4">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <h1 className="text-2xl font-bold">Carga vs tempo útil</h1>
      </div>

      <Tabs defaultValue="semana">
        <TabsList>
          <TabsTrigger value="semana">Semana</TabsTrigger>
          <TabsTrigger value="dia">Por operação (dia a dia)</TabsTrigger>
        </TabsList>

        <TabsContent value="semana" className="mt-3">
          <WeekLoadGrid canEdit />
        </TabsContent>

        <TabsContent value="dia" className="mt-3 space-y-4">
