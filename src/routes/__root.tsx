...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "UP Produção" },
      { name: "description", content: "Gestão de produção de estofos — UP Móveis" },
      { name: "author", content: "UP Móveis" },
      { property: "og:title", content: "UP Produção" },
      { property: "og:description", content: "Gestão de produção de estofos — UP Móveis" },
